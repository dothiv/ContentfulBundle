...
use Dothiv\Bundle\ContentfulBundle\Service\ImageScaler\ImageScalerInterface;
use Dothiv\Bundle\ContentfulBundle\Service\ImageScaler\ThumbnailConfiguration;
use Dothiv\ValueObject\PathValue;
use Dothiv\Bundle\ContentfulBundle\Adapter\ContentfulAssetAdapterInterface;
...
class ImageAssetScaler implements LoggerAwareInterface
{
    ...
    /**
     * @var \Dothiv\Bundle\ContentfulBundle\Adapter\ContentfulAssetAdapterInterface
     */
    ...
    /**
     * @return \Dothiv\Bundle\ContentfulBundle\Service\ImageScaler\ThumbnailConfiguration[]
     */
